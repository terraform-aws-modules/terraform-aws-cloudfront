...
resource "aws_cloudfront_distribution" "this" {
  ...
  dynamic "origin" {
    ...
    content {
      ...
      origin_access_control_id = try(aws_cloudfront_origin_access_control.this[origin.value.origin_access_control].id, lookup(origin.value, "origin_access_control_id", null))
