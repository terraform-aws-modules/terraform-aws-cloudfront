module "wrapper" {
  ...
  connection_function_association = try(each.value.connection_function_association, var.defaults.connection_function_association, null)
  connection_function_code        = try(each.value.connection_function_code, var.defaults.connection_function_code, null)
  connection_function_config      = try(each.value.connection_function_config, var.defaults.connection_function_config, null)
  connection_function_name        = try(each.value.connection_function_name, var.defaults.connection_function_name, null)
  connection_function_policy      = try(each.value.connection_function_policy, var.defaults.connection_function_policy, null)
  ...
  create_connection_function      = try(each.value.create_connection_function, var.defaults.create_connection_function, false)
  ...
  viewer_mtls_config  = try(each.value.viewer_mtls_config, var.defaults.viewer_mtls_config, null)
