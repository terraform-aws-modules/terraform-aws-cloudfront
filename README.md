...
| <a name="input_connection_function_association"></a> [connection\_function\_association](#input\_connection\_function\_association) | A connection function association configuration block for the distribution | <pre>object({<br/>    id = string<br/>  })</pre> | `null` | no |
...
| <a name="input_connection_function_policy"></a> [connection\_function\_policy](#input\_connection\_function\_policy) | IAM policy document as JSON to attach to the CloudFront connection function | `string` | `null` | no |
